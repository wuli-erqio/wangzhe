      ...
      <el-tabs type="border-card" value="base">
        <el-tab-pane label="基础信息" name="base">
          ...
          <el-form-item label="难度">
            <el-rate style="margin-top: 0.6rem" :max="9" show-score v-model="model.scores.defficult"></el-rate>
          </el-form-item>
        ...
        <el-tab-pane label="最佳搭档" name="partners">
          <el-button type="primary" size="small" @click="model.partners.push({})"><i class="el-icon-plus"></i>添加技能</el-button>
          <el-row type="flex" style="flex-wrap: wrap">
...
export default {
  ...
  methods: {
    ...
    async fetch() {
      ...
      // Object.assign({}, this.model, res.data) 相当于将res.data的值赋值到this.model中
